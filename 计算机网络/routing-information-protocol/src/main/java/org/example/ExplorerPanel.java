...
public class ExplorerPanel extends BasePanel {
	...
	public JTree tree;	// 树
	private DefaultMutableTreeNode root, networkRoot, routerRoot;	// 根	网络根	路由器根
	...
	class XDefaultTreeCellRenderer extends DefaultTreeCellRenderer {
		public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded,
			...
			this.setIcon(new ImageIcon(node.getParent() == networkRoot || value == networkRoot ? "images/network_icon.png"
