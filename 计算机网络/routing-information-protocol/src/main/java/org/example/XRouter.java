...
public class XRouter extends BaseLabel {
    ...
    private static final ImageIcon ICON = new ImageIcon(XRouter.class.getResource("/images/router.png")); // 图标
    ...
    private final ArrayList<XInfo> infoList; // 路由表信息
    private final Map<String, Long> acceptTime; // 接收各路由表信息的时间
